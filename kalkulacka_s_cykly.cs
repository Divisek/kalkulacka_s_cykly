...
{
    Console.WriteLine("Vítejte v kalkulaččce");
    ...
    while (pokracovat == "ano") 
    {
        ...
        Console.WriteLine("Chcete počítat něo dalšího?[ano/ne]");
        pokracovat = Console.ReadLine();
    }
    Console.WriteLine("Děkuju za použití kalkulačky, aplikaci ukončíte libovolnopu klávesnicí.");
    Console.ReadKey();
}
